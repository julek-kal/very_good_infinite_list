...
class SliverInfiniteList extends StatefulWidget {
  ...
  @override
  SliverInfiniteListState createState() => SliverInfiniteListState();
}
...
@protected
@visibleForTesting
class SliverInfiniteListState extends State<SliverInfiniteList> {
  late final CallbackDebouncer _debounce;
  ...
  Widget build(BuildContext context) {
    ...
    final showEmpty = !widget.isLoading &&
        widget.itemCount == 0 &&
        widget.emptyBuilder != null;
    final showBottomWidget =
        showEmpty || !widget.hasReachedMax || widget.hasError;
    final showSeparator = widget.separatorBuilder != null;
    final separatorCount = !showSeparator ? 0 : widget.itemCount - 1;
